...
[ApiController]
[Route("apiJikan/[controller]")]
public class ApiJikanController : ControllerBase
{
    private readonly IJikanService _jikanService;
    private readonly ILogger<ApiJikanController> _logger;

    public ApiJikanController(IJikanService jikanService, ILogger<ApiJikanController> logger)
    {
